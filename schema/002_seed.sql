...
-- beroepenavondnijmegen.nl (mei 2026). Admin kan ze later vrij bewerken.
--
-- LET OP: SQLite interpreteert geen \n-escapes binnen TEXT-literals.
-- Echte newlines moeten als regeleinde IN de quotes staan. Dat is hoe
-- multi-line strings hieronder werken.
...
INSERT OR REPLACE INTO categories (id, name, color, sort_order) VALUES
...
INSERT OR REPLACE INTO events (id, year, title, date, venue_name, venue_address, intro_md, is_active) VALUES
